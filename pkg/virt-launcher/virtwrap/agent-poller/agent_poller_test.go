		...
		It("should parse it into a list of interfaces", func() {
			...
			expectedStatuses = append(expectedStatuses,
				api.InterfaceStatus{
					...
					CIDR:          "10.244.0.81/24",
					CIDRs:         []string{"10.244.0.81/24", "fe80::858:aff:fef4:51/64"},
					InterfaceName: "eth0",
				})
			expectedStatuses = append(expectedStatuses,
				api.InterfaceStatus{
					...
					CIDR:          "fe80::ff:feb0:1766/64",
					CIDRs:         []string{"fe80::ff:feb0:1766/64"},
					InterfaceName: "eth1",
				})
			expectedStatuses = append(expectedStatuses,
				api.InterfaceStatus{
					...
					CIDR:          "1.2.3.4/24",
					CIDRs:         []string{"1.2.3.4/24", "fe80::ff:1111:2222/64"},
					InterfaceName: "eth5",
				})
